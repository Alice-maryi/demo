...
public class CopySheets {
    ...
    public static void main(String[] args) throws IOException {
        XSSFWorkbook workbookFrom = new XSSFWorkbook("F:\\农信2022数据\\悦农聚邻售商户2022年全年交易数据.xlsx");
        XSSFWorkbook workbookOut = new XSSFWorkbook();
        copySheets(workbookOut.createSheet(), workbookFrom.getSheetAt(1));
        FileOutputStream outputStream = new FileOutputStream("F:\\农信2022数据\\ttt.xlsx");
     ...
     * @param styleMap -
     */
    public static void copyRow(XSSFSheet srcSheet, XSSFSheet destSheet, XSSFRow srcRow, XSSFRow destRow, Map<Integer, CellStyle> styleMap) {
